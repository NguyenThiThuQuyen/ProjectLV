        ...
        <div className="col-span-1 ">
          <div className="w-full mt-48">
            {/* <div className="w-5/6 mx-auto">
              <div className="mt-36">
                <img className="w-[600px]" src={hinh1} alt="" />
              </div>
            </div> */}
            <div className="ml-10 border-2 border-green-600 py-10 px-5 rounded-md">
              ...
              <div className="mt-8 text-lg text-green-700 font-bold underline underline-offset-4">
                LƯU Ý:
              </div>
        ...
        <div className="col-span-2 ">
          <div className="w-full">
            <div className="w-5/6 mx-auto px-3">
              ...
              <div className="border-l-2 border-l-sky-800">
              ...
              <div className="border-l-2 border-l-sky-800 mt-10">
                <span className="absolute mt-10 left-[594px] w-[20px] h-[20px] bg-sky-600 rounded-full"></span>
              ...
              <div className="mt-10 w-full pr-5 text-right">
                ...
                <button
                  className="ml-5 rounded px-6 py-3 font-semibold text-white hover:text-black

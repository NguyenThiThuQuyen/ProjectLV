...
function Footer() {
  return (
    <>
      <div className="bg-slate-200 bottom-0 w-full">
        <div className="grid grid-cols-4 h-fit w-10/12 mx-auto">
          <div className="col-span-1 px-10">
            <div className="font-medium text-lg mt-3">Children Care</div>
            <ul>
              <li className="my-3 text-gray-700">
                6 Nguyen Luong Bang St.Saigon South (Phu My Hung),Dist.7, Ho Chi
                Minh City,Vietnam
              </li>
          ...
          <div className="col-span-1 px-10">
            <div className="font-medium text-lg mt-3">Location</div>
            <ul>
            ...
            <div className="font-medium text-lg mt-3">For Professionals</div>
            <ul>
          ...
          <div className="col-span-1 px-10">
            <div className="font-medium text-lg mt-3">Useful Links</div>
            <ul>
          ...
          <div className="col-span-1 px-10">
            <div className="font-medium text-lg mt-3">Follow us</div>
